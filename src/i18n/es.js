const es = {
  ...
  hero_iam: "Construyo",
  hero_sub:
    "Desarrollador frontend con 5 años creando aplicaciones Angular empresariales. Apasionado por las interfaces eficientes y atractivas, cuidando el rendimiento y una experiencia de usuario fluida e intuitiva.",
  ...
  // Companies strip
  strip_label: "Empresas para las que he trabajado",

  // About
  about_ey: "Conóceme",
  about_h: "Sobre mí",
  about_c1t: "Formación",
  about_c1s: "Desarrollo de Apps Multiplataforma · DAM",
  about_c2t: "Universidad",
  ...
  // Contact
  ct_ey: "Contacto",
  ct_h: "Construyamos algo",
  ct_sub:
    "¿Tienes un proyecto en mente o solo quieres saludar? Cuéntame, suelo responder en un día.",
  ct_phone: "Teléfono",
  ...
  // Footer
  ft_rights: "© 2026 León Arellano · Desarrollador Frontend",
  ft_top: "Volver arriba ↑",
};
